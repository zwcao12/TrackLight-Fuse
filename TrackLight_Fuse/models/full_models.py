...
class FeatureExtractors(torch.nn.Module):
    def __init__(self, device, 
        ...
        ## RGB backbone
        self.rgb_backbone = timm.create_model(model_name = rgb_backbone_name, pretrained = True, pretrained_cfg_overlay = dict(file='/media/newdisk/gy/anomaly/crossmodal-feature-mapping-main/pretrain/pytorch_model.bin'), **kwargs)
